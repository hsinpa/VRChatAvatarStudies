...
Shader "YOYOGI_MORI/YMToon/Base" {
...
//other
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Cgincs/YMT_Outline.cginc"
            ENDCG
        }
        ...
        Pass
        {
            Name "ForTransparentZWrite"
            ZWrite [_ZWrite4Trans]
            ColorMask 0
        }
        ...
        Pass
        {
            ...
            #include "Cgincs/YMT_ForwardBackBase.cginc"
        ...
        Pass
        {
            ...
            #include "Cgincs/YMT_ForwardAdd.cginc"
        ...
        Pass
        {
            ...
            #include "Cgincs/YMT_ShadowCaster.cginc"
            ENDCG
        }
